...
public class MyIndicatorAdapter extends IndicatorViewPager.IndicatorViewPagerAdapter {
    ...
    public MyIndicatorAdapter(Context context, List<NewsData.DataBean.ChildrenBean> children, List<NewsDetail> newsDetail){
...
//        NewsData.DataBean.ChildrenBean childrenBean = children.get(position);
        NewsDetail newsDetail = newsdetail.get(position);
